...
<main>
    <div class="wrapper-main">
        ...
        <div class="wrapper-option">
            <button class="button">
                <svg id="search" xmlns="http://www.w3.org/2000/svg" class="icon-svg" width="24" height="24"
            ...
            <button class="button">
                <svg id="filter" class="icon-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                     viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                     stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
